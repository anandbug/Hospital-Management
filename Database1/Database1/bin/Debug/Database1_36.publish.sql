...
GO
PRINT N'Rename refactoring operation with key 22e4edaa-20cd-4722-a33e-688b8be22c83 is skipped, element [dbo].[prescription].[Id] (SqlSimpleColumn) will not be renamed to pid';
...
AS 
	SELECT SUM(charge) as yearcharge
